...
enum PhiloSig {    /* internal Philosopher events (not published to the QF) */
                      ...
                      void *stkSto, uint32_t stkSize)
{
    ...
    Philosopher_ctor(&l_philo[n]);                    /* explicit Ctor call */
    ie.philNum = n;
    QActive_start((QActive *)&l_philo[n], prio,
