...
* Date of the Last Update:  Aug 04, 2005
*
...
void QF_publish(QEvent const *e) {
...
#if (QF_MAX_ACTIVE <= 8)
    {
        ...
        while (tmp != (uint8_t)0) {
            ...
            QACTIVE_POST_FIFO_(QF_active_[p], e);             /* see NOTE02 */
...
*
* NOTE02:
* The macro QACTIVE_POST_FIFO() used for posting events does NOT increment
