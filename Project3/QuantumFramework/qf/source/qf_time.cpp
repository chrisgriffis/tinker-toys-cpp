...
/// \ingroup qf
/// \file qf_time.cpp
/// \brief QF_tickCtr_ definition and QF::getTime() implementation.

// Package-scope objects -----------------------------------------------------
QTimeEvtCtr QF_tickCtr_;                     // counter incremented every tick

//............................................................................
QTimeEvtCtr QF::getTime(void) {                                  // see NOTE01
    QF_INT_LOCK_KEY_
    QF_INT_LOCK_();
    QTimeEvtCtr tickCtr = QF_tickCtr_;
    QF_INT_UNLOCK_();
    return tickCtr;
}

//////////////////////////////////////////////////////////////////////////////
// NOTE01: The value returned by QF::getTime() has no meaningful absolute
// value but is meaningful only relatively to the values returned at other
// time instances. The internal QF_tickCtr_ counter wraps around through
// 0xFFFFFFFF to 0, which is transparent to any time difference calculations.
//
// For example, a time
// difference calculated accross the wrap around might look as follows:
//
// t1 == 0xFFFFFFFB (QF::getTime() value returned at instance 1)
// t2 == 0x00000003 (QF::getTime() value returned 8 ticks after instance 1)
//
