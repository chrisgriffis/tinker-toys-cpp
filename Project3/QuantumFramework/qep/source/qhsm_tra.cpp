...
/// \ingroup qep
/// \file qhsm_tra.cpp
/// \brief QHsm::execTran() implementation.
...
//............................................................................
void QHsm::execTran(QHsmState path[], QTran_ *tran) {
    QHsmState s;
                    ...
                    if (iq == (int8_t)0) {           // the LCA not found yet?
                        ...
                        if (t == (QHsmState)0) {     // the LCA not found yet?
                            ...
                            do {
                                ...
                                if (t != (QHsmState)0) {  // exit not handled?
                                ...
                                do {
                                    if (s == path[iq]) {   // is this the LCA?
                                        ...
                                        s = (QHsmState)0;// and the outer loop
                                    }
                                    else {
                                        --iq;
                                    }
    ...
    state_.hsm = s;                                // update the current state

    while (QEP_TRIG_(s, Q_INIT_SIG) == (QHsmState)0) {// drill into the target
        ...
        if (tran != (QTran_ *)0) {                       // static tranistion?
    ...
    if (tran != (QTran_ *)0) {                           // static transition?
