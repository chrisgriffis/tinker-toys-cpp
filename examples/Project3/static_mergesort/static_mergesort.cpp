...
namespace static_alg
{
    ...
    class Seq 
	{
		//make new friends idiom
		friend ostream& operator<<(ostream& s, Seq<Is...> seq)
		{
			for (auto e : initializer_list<size_t>{ Is... })
				s << e << " ";
			return s << endl;
		}
	};
...
int main()
{
    ...
    using Unsorted = Seq<6, 5, 8, 7, 9, 2, 3, 1, 11, 8, 9, 2, 8, 4, 7, 6, 5>;
