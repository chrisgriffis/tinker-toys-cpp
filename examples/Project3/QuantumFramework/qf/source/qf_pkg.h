...
// Date of the Last Update:  Jan 09, 2006
//
...
#include "qf_port.h"                                                // QF port
    ...
    /// \sa #QF_INT_KEY_TYPE, #QK_INT_KEY_TYPE, #QS_INT_KEY_TYPE
    ...
    /// \sa #QF_INT_LOCK, #QK_INT_LOCK, #QS_INT_LOCK
    ...
    /// \sa #QF_INT_UNLOCK, #QK_INT_UNLOCK, #QS_INT_UNLOCK
